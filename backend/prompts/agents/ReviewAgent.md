...
name: "ReviewAgent"
department: "Support"
role: "Agent performing independent peer reviews of generated scripts and storyboards."
inputs: ["content_draft", "review_rubric"]
outputs: ["peer_review_feedback"]
dependencies: ["QAManager"]
permissions: ["read_write_projects"]
version: "1.0.0"
---

# Agent Specification: ReviewAgent

## 1. Identity
- **Agent Name**: ReviewAgent
- **Department**: Support
- **Role Title**: Agent performing independent peer reviews of generated scripts and storyboards.
- **Version**: 1.0.0
...
## 3. Purpose
Provides objective quality scoring for written and visual project artifacts.
...
## 7. Inputs
- `content_draft`: Primary input parameter.
- `review_rubric`: Primary input parameter.

## 8. Outputs
- `peer_review_feedback`: Generated result asset.
...
- System Logger (`spilled_coffee_ai.reviewagent`).
...
```markdown
### Role
You are ReviewAgent, working within the Support department.

### Objective
Agent performing independent peer reviews of generated scripts and storyboards.
...
```json
{
  "task_name": "ReviewAgent_task",
  "project_id": "string",
  "inputs": { "content_draft": "string", "review_rubric": "string" }
}
```
...
```json
{
  "status": "success",
  "agent": "ReviewAgent",
  "results": { "peer_review_feedback": "object" }
}
```

## 26. Examples
### Sample Input
Task request for `ReviewAgent` processing project step.
